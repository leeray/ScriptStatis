...
result_android_phone = {'vv':0, 'local':0, 'playcode':0, 'PC100':0, 'PC101':0, 'PC102':0, 'PC104':0, 'PC105':0, 'PC106':0, 'PC999':0, 'PCother':0, 'PC200':0}
result_android_pad = {'vv':0, 'local':0, 'playcode':0, 'PC100':0, 'PC101':0, 'PC102':0, 'PC104':0, 'PC105':0, 'PC106':0, 'PC999':0, 'PCother':0, 'PC200':0}
result_iphone = {'vv':0, 'local':0, 'playcode':0, 'PC100':0, 'PC101':0, 'PC102':0, 'PC104':0, 'PC105':0, 'PC106':0, 'PC999':0, 'PCother':0, 'PC200':0}
result_ipad = {'vv':0, 'local':0, 'playcode':0, 'PC100':0, 'PC101':0, 'PC102':0, 'PC104':0, 'PC105':0, 'PC106':0, 'PC999':0, 'PCother':0, 'PC200':0}
...
while row:
    row = row.strip()
    _pid, _vv, _local, _playcode, _pc100, _pc101, _pc102, _pc104, _pc105, _pc106, _pc999, _pcother, _pc200 = [x.strip() for x in row.split(' ')] 
    #_pid, _vv, _local, _playcode = [x.strip() for x in row.split(' ')] 

    print '_pid:%s _vv:%s _local:%s _playcode:%s' % (_pid, _vv, _local, _playcode)
...
print >> out_f, u"OS, VV, 本地VV, 失败VV, -100, -101, -102, -104, -105, -106, -999, other, 200"

print >> out_f, "Android Phone, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s" % (result_android_phone['vv'], result_android_phone['local'], result_android_phone['playcode'],result_android_phone['PC100'],result_android_phone['PC101'],result_android_phone['PC102'],result_android_phone['PC104'],result_android_phone['PC105'],result_android_phone['PC106'],result_android_phone['PC999'],result_android_phone['PCother'],result_android_phone['PC200'])

print >> out_f, "Android Pad, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s" % (result_android_pad['vv'], result_android_pad['local'], result_android_pad['playcode'],result_android_pad['PC100'],result_android_pad['PC101'],result_android_pad['PC102'],result_android_pad['PC104'],result_android_pad['PC105'],result_android_pad['PC106'],result_android_pad['PC999'],result_android_pad['PCother'],result_android_pad['PC200'])

print >> out_f, "iPhone, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s" % (result_iphone['vv'], result_iphone['local'], result_iphone['playcode'],result_iphone['PC100'],result_iphone['PC101'],result_iphone['PC102'],result_iphone['PC104'],result_iphone['PC105'],result_iphone['PC106'],result_iphone['PC999'],result_iphone['PCother'],result_iphone['PC200'])

print >> out_f, "iPad, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s" % (result_ipad['vv'], result_ipad['local'], result_ipad['playcode'],result_ipad['PC100'],result_ipad['PC101'],result_ipad['PC102'],result_ipad['PC104'],result_ipad['PC105'],result_ipad['PC106'],result_ipad['PC999'],result_ipad['PCother'],result_ipad['PC200'])
